...
@section('title', 'Clio 5 - Location de Voiture')
...
<div class="carousel">
    <img class="active" src="{{ asset('https://www.coraliacars.com/wp-content/uploads/2024/09/Renault-Clio-5-1.webp') }}" alt="Clio 5 extérieur">
...
<div class="reservation-form">
    ...
    <form action="{{ route('reservations.store') }}" method="POST">
        ...
        <input type="hidden" name="car_model" value="Clio 5">
        ...
        <button type="submit">Réserver la Clio 5</button>
    </form>
</div>
