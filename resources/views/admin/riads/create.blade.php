...
@section('title', 'Add New Riads')

@section('content')
    <div class="container mx-auto">
        <h2 class="text-3xl font-bold text-gray-800 mb-6">Add New Riads</h2>

        <div class="bg-white rounded-xl shadow-lg p-8">
            <form action="{{ route('admin.riads.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- Name Field -->
                <div class="mb-5">
                    <label for="name" class="block text-gray-700 text-sm font-bold mb-2">riads Name:</label>
                ...
                <div class="flex items-center justify-end">
                    <button type="submit" class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white text-lg font-semibold rounded-lg shadow-md transition duration-200 ease-in-out transform hover:scale-105">
                        <i class="fas fa-save mr-2"></i> Create riads
                    </button>
