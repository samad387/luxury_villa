...
@section('title', 'Tmax 530 dx - Location des motos')
...
<div class="carousel">
    <img class="active" src="https://media.motoservices.com/media/cache/vehicle_detail/media/vehicle/1600/2017_yam_xp500a_eu_smx_stu_001_03.jpg" alt="Tmax 530 dx">
...
<div class="reservation-form">
    ...
    <form action="{{ route('reservations.store') }}" method="POST">
        ...
        <button type="submit">Réserver le TMAX 530 DX</button>
    </form>
</div>
