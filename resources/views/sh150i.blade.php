...
@section('title', 'sh 150i - Location des motos')
...
<div class="carousel">
    <img class="active" src="https://www.honda-motorcycles.gr/images/upload/Productsslideshowmore46-8585011125179592765-s0.webp" alt="Tmax 530 dx">
...
<div class="details">
    <h2> SH 150i - Puissance et Style</h2>
    <p>Louez le SH 150i pour vos trajets urbains ou balades sur route. Confort, sportivité et design moderne pour une expérience unique à Marrakech.</p>
    <p class="price">Prix : 400 MAD / jour</p>
</div>
...
<div class="reservation-form">
    ...
    <form action="{{ route('reservations.store') }}" method="POST">
        ...
        <input type="hidden" name="car_model" value="TMAX 530 DX">
        ...
        <button type="submit">Réserver le SH 150i</button>
    </form>
</div>
